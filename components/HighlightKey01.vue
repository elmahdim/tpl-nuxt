    ...
    <div class="grid md:grid-cols-2 gap-12">
      ...
      <div class="space-y-6 lg:space-y-10">
        ...
        <div class="flex gap-x-5 sm:gap-x-8">
          <!-- Icon -->
          <span
            class="shrink-0 inline-flex justify-center items-center size-[46px] rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm mx-auto"
          >
            <svg
        ...
        <div class="flex gap-x-5 sm:gap-x-8">
          <!-- Icon -->
          <span
            class="shrink-0 inline-flex justify-center items-center size-[46px] rounded-full border border-gray-200 bg-white shadow-sm mx-auto"
          >
            <svg
              class="shrink-0 size-5"
              xmlns="http://www.w3.org/2000/svg"
