  ...
  >
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
      ...
      <div class="flex justify-center">
        <a
          class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-sm text-gray-800 p-1 ps-3 rounded-full transition hover:border-gray-300 focus:outline-none focus:border-gray-300"
          href="#"
        >
      ...
      <div class="mt-8 gap-3 flex justify-center">
        ...
        >
          $ npm i preline
          <span
            class="flex justify-center items-center bg-gray-200 rounded-md size-7"
          >
            <svg
      ...
      <div class="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
        <span class="text-sm">Package Manager:</span>
