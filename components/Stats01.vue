<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="grid items-center lg:grid-cols-12 gap-6 lg:gap-12">
      ...
      <div
        class="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-neutral-300"
      >
        <div
          class="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8"
        >
          <!-- Stats -->
          <div>
            <p class="text-3xl font-semibold text-blue-600">99.95%</p>
            <p class="mt-1">in fulfilling orders</p>
          </div>
          <!-- End Stats -->
          ...
          <div>
            ...
            <p class="mt-1">partner with Preline</p>
          </div>
          <!-- End Stats -->
          ...
          <div>
            ...
            <p class="mt-1">this year alone</p>
          </div>
          <!-- End Stats -->
        </div>
      </div>
